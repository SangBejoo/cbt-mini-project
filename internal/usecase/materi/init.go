...
type MateriUsecase interface {
	CreateMateri(idMataPelajaran int, nama string, idTingkat int) (*entity.Materi, error)
	GetMateri(id int) (*entity.Materi, error)
	UpdateMateri(id, idMataPelajaran int, nama string, idTingkat int) (*entity.Materi, error)
