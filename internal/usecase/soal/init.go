...
type SoalUsecase interface {
	CreateSoal(idMateri, idTingkat int, pertanyaan, opsiA, opsiB, opsiC, opsiD, pembahasan string, jawabanBenar entity.JawabanOption, imageFilesBytes [][]byte) (*entity.Soal, error)
	GetSoal(id int) (*entity.Soal, error)
	UpdateSoal(id, idMateri, idTingkat int, pertanyaan, opsiA, opsiB, opsiC, opsiD, pembahasan string, jawabanBenar entity.JawabanOption, imageFilesBytes [][]byte) (*entity.Soal, error)
